...
{
    /** La méthode showHome prend en paramètre deux injections de dépendance (Repository) qui vont nous éviter de devoir récupérer les repository dnas le controleur avec $this->getDoctrine()->getManager()->getRepository()
